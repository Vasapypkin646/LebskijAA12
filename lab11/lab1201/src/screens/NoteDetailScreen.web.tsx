    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.mapPlaceholder}>
                <Text style={styles.mapPlaceholderText}>🗺️ Карта доступна только в мобильной версии</Text>
                <Text style={styles.coordinatesText}>
                    Координаты: {note.latitude.toFixed(6)}, {note.longitude.toFixed(6)}
                </Text>
            </View>
            ...
            {note.photoUri && (
                <View style={styles.photoContainer}>
                    ...
                    <Text style={styles.photoText}>Фото доступно в мобильной версии</Text>
                </View>
            )}
